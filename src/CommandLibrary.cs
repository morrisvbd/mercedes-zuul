...
class CommandLibrary
{
	...
	public CommandLibrary()
	{
		...
		validCommands.Add("hulp");
		validCommands.Add("ga");
		validCommands.Add("stoppen");
		validCommands.Add("kijkrond");
		validCommands.Add("status");
		validCommands.Add("oppakken");
		validCommands.Add("laatnvallen");
		validCommands.Add("gebruik");
	}
